        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    ...
                    <p>
                        Con mas de 16 años de trabajo constante, Grupo Vargas SAC a participado de los cambios del mercado nacional, convirtiéndose en una empresa solida y de constante evolución.

                        Nuestra política es proveer productos y soluciones de calidad que satisfagan las necesidades de nuestros clientes y representen su mejor alternativa.
                    </p>
                </div>
                <div class="col-md-4">
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Más de 90 años dedicados a la fabricación e instalación de vidrios, cristales,aluminio y más. Tu vidriería las 24 horas del día.
                </p>
            </div>
        </div>
        <div class="row">
