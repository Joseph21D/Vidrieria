    ...
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (res.totalPaypal > 0) {
                res.productos.forEach((producto) => {
                    html += `<tr>
                      ...
                      <td class="text-center">
                          <span class="badge bg-warning fs-6">${res.moneda + producto.precio
                        }</span>
                      </td>
                      <td class="text-center">
                          <span class="badge bg-primary fs-6">${producto.cantidad
                        }</span>
                      </td>
                      <td class="text-center">
                          <span class="badge bg-success fs-6">${res.moneda + producto.subTotal
                        }</span>
                      </td>
                  </tr>`;
                });
          ...
          <div class="d-flex justify-content-end align-items-center">
            ...
            <span class="badge bg-light me-2 fs-5 text-dark">${res.moneda + res.total
